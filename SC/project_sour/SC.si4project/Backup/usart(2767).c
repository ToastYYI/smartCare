...
switch(*str)
{
case '%':<span style="white-space:pre">	</span>//·¢ËÍ²ÎÊı
str++;
switch(*str)
{
case 'd': //10½øÖÆÊä³ö
...
if(ch <= 9)
m_putchar(ch + '0');<span style="white-space:pre">	</span>//Êı×Öµ½×Ö·ûµÄ×ª»» 
else 
m_putchar(ch - 10 + 'a');
count--;
}
...
res += 1;
break;
     defaut £º  //ÏÔÊ¾Ô­À´µÄ²ÎÊıµÄ×Ö·û´®(²»ÊÇ..ÀïµÄ²ÎÊıo)
m_putchar(*str);
res += 1;
}
str++;
