package com.jt28.a6735.sc.adapter;
...
public class DeviceListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        Log.d("lhb", String.valueOf(bluetoothDevices.get(position).getBondState()));
        Log.d("lhb", Arrays.toString(bluetoothDevices.get(position).getUuids()));
